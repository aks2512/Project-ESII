...
<body>
  <div class="container">
    ...
    <div class="btn-group" role="group">
      <button id="administracao-funcionarios" type="button" class="btn btn-primary btn-opcoes">Servidores Públicos</button>
      <button id="administracao-projetos" type="button" class="btn btn-primary btn-opcoes">Projetos</button>
      <button id="administracao-interesses" type="button" class="btn btn-primary btn-opcoes">Pesquisa de Interesses</button>
    </div>
  ...
  <script>
    ...
    $(document).ready(function (){
                    $.ajax({
                            url: 'administracao-funcionarios.html',
