...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <input class="form-control" placeholder="Digite a Quantidade de Categorias" id="reqtde" name="remQtd"></br>
        <div id="reinput"></div>
    </div>

    <div class="form-group">
        <label>Descontos Obrigatórios</label>
        <input class="form-control" placeholder="Digite a Quantidade de Categorias" id="deqtde" name="desQtd"></br>
