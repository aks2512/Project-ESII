...
<div class="col-md-12 text-center " id="funcoes">
            ...
            <div class="col-md-4 mt-2">
              <div class="row justify-content-center align-items-center">
                ...
                <select class="col-md-6" id="projeto" name="projeto" type="number">
                  <option value="1">Lei Ordinaria</option>
                  <option value="2">Lei Ordinaria</option>
                  <option value="3">Lei Ordinaria</option>
                  <option value="4">Lei Ordinaria</option>
                </select>
              </div>
            </div>
        </div>
    ...
    <div class="row justify-content-end align-left mt-5">
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" id="detalhes"></div>
    </div>
  </div>
